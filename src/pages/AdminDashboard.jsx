            ...
            <div className="user-details">
              ...
              <div className="details-grid">
                ...
                <div className="detail-item">
                  ...
                  <span>KES {(userDetails.wallet?.balance || 0).toLocaleString()}</span>
                </div>
              </div>
          ...
          <div className="withdrawals-list">
            {pendingWithdrawals.length === 0 ? (
              ...
              pendingWithdrawals.map(withdrawal => (
                <div key={withdrawal.withdrawalId} className="withdrawal-item">
                  ...
                  <div className="withdrawal-actions">
                    <button
                      onClick={() => onApproveWithdrawal(withdrawal.uid, withdrawal.withdrawalId)}
                      disabled={busy}
                    ...
                    <button
                      onClick={() => onRejectWithdrawal(withdrawal.uid, withdrawal.withdrawalId)}
                      disabled={busy}
